...
<div id="header" class="page-navbar">
    ...
    <a href="index.html" class="navbar-brand hidden-xs hidden-sm">
        <img src="{{url('administrator/dynamic/img/logo.png')}}" class="logo hidden-xs" alt="Dynamic logo">
        <img src="{{url('administrator/dynamic/img/logosm.png')}}" class="logo-sm hidden-lg hidden-md" alt="Dynamic logo">
    </a>
    <!-- / navbar-brand -->
    <!-- .no-collapse -->
